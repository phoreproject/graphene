...
func (m *InitialPeers) Reset()         { *m = InitialPeers{} }
func (m *InitialPeers) String() string { return proto.CompactTextString(m) }
func (*InitialPeers) ProtoMessage()    {}
func (*InitialPeers) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{5}
}

func (m *InitialPeers) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_InitialPeers.Unmarshal(m, b)
}
func (m *InitialPeers) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_InitialPeers.Marshal(b, m, deterministic)
}
func (m *InitialPeers) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InitialPeers.Merge(m, src)
}
func (m *InitialPeers) XXX_Size() int {
	return xxx_messageInfo_InitialPeers.Size(m)
}
func (m *InitialPeers) XXX_DiscardUnknown() {
	xxx_messageInfo_InitialPeers.DiscardUnknown(m)
}

var xxx_messageInfo_InitialPeers proto.InternalMessageInfo

func (m *InitialPeers) GetPeers() []*Peer {
	if m != nil {
		return m.Peers
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*InitialPeers)(nil), "pb.InitialPeers")
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type P2PRPCClient interface {
	GetConnectionStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ConnectionStatus, error)
	GetPeers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetPeersResponse, error)
	ListenForMessages(ctx context.Context, in *SubscriptionRequest, opts ...grpc.CallOption) (P2PRPC_ListenForMessagesClient, error)
	Connect(ctx context.Context, in *InitialPeers, opts ...grpc.CallOption) (*ConnectResponse, error)
	Disconnect(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*DisconnectResponse, error)
	GetSettings(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*P2PSettings, error)
}
...
func (c *p2PRPCClient) GetConnectionStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ConnectionStatus, error) {
...
func (c *p2PRPCClient) GetPeers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetPeersResponse, error) {
...
func (c *p2PRPCClient) ListenForMessages(ctx context.Context, in *SubscriptionRequest, opts ...grpc.CallOption) (P2PRPC_ListenForMessagesClient, error) {
...
func (c *p2PRPCClient) Connect(ctx context.Context, in *InitialPeers, opts ...grpc.CallOption) (*ConnectResponse, error) {
...
func (c *p2PRPCClient) Disconnect(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*DisconnectResponse, error) {
	out := new(DisconnectResponse)
	err := c.cc.Invoke(ctx, "/pb.P2PRPC/Disconnect", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *p2PRPCClient) GetSettings(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*P2PSettings, error) {
	out := new(P2PSettings)
...
type P2PRPCServer interface {
	GetConnectionStatus(context.Context, *Empty) (*ConnectionStatus, error)
	GetPeers(context.Context, *Empty) (*GetPeersResponse, error)
	ListenForMessages(*SubscriptionRequest, P2PRPC_ListenForMessagesServer) error
	Connect(context.Context, *InitialPeers) (*ConnectResponse, error)
	Disconnect(context.Context, *Empty) (*DisconnectResponse, error)
	GetSettings(context.Context, *Empty) (*P2PSettings, error)
}
...
func _P2PRPC_GetConnectionStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P2PRPCServer).GetConnectionStatus(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _P2PRPC_GetPeers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P2PRPCServer).GetPeers(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _P2PRPC_Connect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P2PRPCServer).Connect(ctx, req.(*InitialPeers))
	}
	return interceptor(ctx, in, info, handler)
}

func _P2PRPC_Disconnect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(P2PRPCServer).Disconnect(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.P2PRPC/Disconnect",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P2PRPCServer).Disconnect(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _P2PRPC_GetSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P2PRPCServer).GetSettings(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _P2PRPC_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _P2PRPC_Disconnect_Handler,
		},
		{
