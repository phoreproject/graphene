...
func TestAttestationData_Equals(t *testing.T) {
	baseAtt := &primitives.AttestationData{
		...
		EpochBoundaryHash:   chainhash.HashH([]byte("epoch")),
		ShardBlockHash:      chainhash.HashH([]byte("shard")),
		LatestCrosslinkHash: chainhash.HashH([]byte("crosslink")),
		JustifiedSlot:       0,
		JustifiedBlockHash:  chainhash.HashH([]byte("justifiedblockhash")),
	}
	...
	testCases := []struct {
		...
		},
		{
			attData: &primitives.AttestationData{
				...
				Shard:               0,
				BeaconBlockHash:     chainhash.HashH([]byte("beacon")),
				EpochBoundaryHash:   chainhash.HashH([]byte("epoch1")),
				ShardBlockHash:      chainhash.HashH([]byte("shard")),
				LatestCrosslinkHash: chainhash.HashH([]byte("crosslink")),
				JustifiedSlot:       0,
				JustifiedBlockHash:  chainhash.HashH([]byte("justifiedblockhash")),
		...
		},
		{
			attData: &primitives.AttestationData{
				...
				LatestCrosslinkHash: chainhash.HashH([]byte("crosslink")),
				JustifiedSlot:       0,
				JustifiedBlockHash:  chainhash.HashH([]byte("justifiedblockhash1")),
			},
			equalsBase: false,
		},
	}
